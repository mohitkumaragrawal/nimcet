...
const EligibilityCriteria = () => {
  return (
    <Page title="Eligibility Criteria">
      <RootStyle>
        <RootStyle>
          <Typography sx={{ mx: 8 }} variant="h3">
            ELIGIBILITY CRITERIA TO APPEAR FOR NIMCET 2023
          </Typography>
          <Container sx={{ my: 8, width: '70%' }}>
            ...
            >
              <b>
                Indian Nationals securing at least 60% marks in aggregate or 6.5 CGPA on a 10-point scale (55% marks or
                6.0 CGPA on a 10-point scale in case of SC/ ST/PwD) in
              </b>
            </Typography>
